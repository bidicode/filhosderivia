...
<div class="contato">
    <div class="maps-section">
        <div class="text-map">Bússola dos Ventos Élficos</div>
        <div class="maps">
        ...
        <div class="status-contato">
            <img src="assets/images/cards/bussola_elfica.png"/>
            <div>+ 10 Navegação</div>
        </div>
        <div class="descricao-contato">
            <div>Forjada com magia élfica ancestral. Ao ser tocada, ela sopra a rota até os Filhos de Rívia. Seguir é inevitável.</div>
            <div>Localizada há duas quadras da Estação Niterói (Canoas/RS).</div>
        </div>
    </div>
    <div class="instagram-section">
        <iframe src="https://www.instagram.com/p/DJW6k00xIv6/embed"
          width="100%"
          height="100%"
          frameborder="0"
          scrolling="no"
